...
| Bundle | `elektron-capture-ios-lifecycle.bundle` (pin name only; do not use generic `elektron-capture-ios-complete.bundle`) |
| Bundle SHA-256 | `1f39196a90e5e9d875bf47d093105b7f407a9faa52b39b207ba7536e2b2766a6` |
| ZIP | `elektron-capture-ios-lifecycle.zip` (pin name only; do not use generic `elektron-capture-ios-working-tree.zip`) |
...
1. Fresh clone of `elektron-capture-ios-lifecycle.bundle` → `git rev-parse HEAD` = `413dfe59efd567777e16d289d4f054d30c571fac`
