...
This tip is **Commit B+ staging** on the Track B lineage culminating in  
`cursor/ekp-knowledge-artifacts-d881` / `cursor/capture-v2-engineering-audit-d881`  
(ancestors: `cursor/phase1c-evidence-library-handoff-d881`).  
...
Engineering baseline map: `Docs/Audits/` (`CHANGE-0007`).
