...
1. **Implementation handoff** — next coding session (`IMPLEMENTATION_HANDOFF.md`)
...
- Root living docs: `IMPLEMENTATION_HANDOFF.md`, `PROJECT_STATE.md`, `REPOSITORY_MEMORY.md`
- EKP contract: `Docs/Governance/ELEKTRON_KNOWLEDGE_PACKAGE.md`
- Tracked stubs: `KnowledgePackage/`
