...
export function SidePanel() {
  ...
  return (
    <aside className="side-panel">
      ...
      <section>
        <h3>Property maturity matrix</h3>
        <dl className="maturity-grid">
          <div>
            <dt>Identity</dt>
            <dd>{selected.maturity_matrix.identity_status}</dd>
          </div>
          <div>
            <dt>Geometry</dt>
            <dd>{selected.maturity_matrix.geometry_status}</dd>
          </div>
          <div>
            <dt>Placement</dt>
            <dd>{selected.maturity_matrix.placement_status}</dd>
          </div>
          <div>
            <dt>Mass</dt>
            <dd>{selected.maturity_matrix.mass_status}</dd>
          </div>
          <div>
            <dt>Interface</dt>
            <dd>{selected.maturity_matrix.interface_status}</dd>
          </div>
        </dl>
        <p className="tiny muted">
          Orthogonal statuses — one badge cannot certify identity, geometry, placement, mass, and
          interfaces together.
        </p>
      </section>
