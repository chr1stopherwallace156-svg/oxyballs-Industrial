...
## Precision-law upgrade
- Ambiguous winding reject + CCW enforcement
- Voxel-centroid LOD with 50%/25% triangle targets + metrics
- GLB Float32 LE + soft-fail `GLB_EXPORT_SKIPPED`
