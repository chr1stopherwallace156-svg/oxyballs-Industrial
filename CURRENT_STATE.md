...
```text
IMPLEMENTATION_STATE           = SOURCE_IMPLEMENTED (Sprint 3.5 proposed)
...
|---|---|---|
| **Capture iOS** | Sprint 3.4 orchestration merged. Sprint 3.5 quality/coverage/guidance proposed (fixture SPKG-FIXTURE-GUIDED-CAPTURE-000001). | Apple runtime unvalidated until Sprint 3.6. No Phase 4. |
