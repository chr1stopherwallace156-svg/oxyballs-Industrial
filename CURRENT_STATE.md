...
```text
IMPLEMENTATION_STATE           = SOURCE_IMPLEMENTED (Sprint 3.4 proposed)
...
|---|---|---|
| **Capture iOS** | Sprint 3.3 depth foundation merged. Sprint 3.4 multi-stream orchestration proposed (fixture SPKG-FIXTURE-COORDINATED-000001). | Apple runtime unvalidated until Sprint 3.6. No Sprint 3.5/Phase 4. |
